...
export type XpSourceId = 'wordle_win' | 'wordle_first' | 'trivia_correct' | 'blackjack_win' | 'blackjack_natural' | 'prediction_win' | 'roulette_win';
...
export const XP_SOURCES: Record<XpSourceId, XpRange> = {
  ...
  blackjack_natural: { min: 6, max: 16 },
  prediction_win: { min: 25, max: 45 },
